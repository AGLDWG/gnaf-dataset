DROP TABLE gnaf.STREET_LOCALITY_POINT CASCADE;
DROP TABLE gnaf.PRIMARY_SECONDARY CASCADE;
DROP TABLE gnaf.ADDRESS_MESH_BLOCK_2016 CASCADE;
DROP TABLE gnaf.ADDRESS_SITE_GEOCODE CASCADE;
DROP TABLE gnaf.LOCALITY_ALIAS CASCADE;
DROP TABLE gnaf.LOCALITY_POINT CASCADE;
DROP TABLE gnaf.ADDRESS_MESH_BLOCK_2011 CASCADE;
DROP TABLE gnaf.ADDRESS_ALIAS CASCADE;
DROP TABLE gnaf.LOCALITY_NEIGHBOUR CASCADE;
DROP TABLE gnaf.ADDRESS_DEFAULT_GEOCODE CASCADE;
DROP TABLE gnaf.STREET_LOCALITY_ALIAS CASCADE;
DROP TABLE gnaf.MB_2016 CASCADE;
DROP TABLE gnaf.ADDRESS_DETAIL CASCADE;
DROP TABLE gnaf.MB_MATCH_CODE_AUT CASCADE;
DROP TABLE gnaf.MB_2011 CASCADE;
DROP TABLE gnaf.STREET_LOCALITY_ALIAS_TYPE_AUT CASCADE;
DROP TABLE gnaf.LOCALITY_ALIAS_TYPE_AUT CASCADE;
DROP TABLE gnaf.GEOCODE_TYPE_AUT CASCADE;
DROP TABLE gnaf.ADDRESS_ALIAS_TYPE_AUT CASCADE;
DROP TABLE gnaf.PS_JOIN_TYPE_AUT CASCADE;
DROP TABLE gnaf.GEOCODED_LEVEL_TYPE_AUT CASCADE;
DROP TABLE gnaf.STREET_CLASS_AUT CASCADE;
DROP TABLE gnaf.STREET_LOCALITY CASCADE;
DROP TABLE gnaf.ADDRESS_SITE CASCADE;
DROP TABLE gnaf.LEVEL_TYPE_AUT CASCADE;
DROP TABLE gnaf.FLAT_TYPE_AUT CASCADE;
DROP TABLE gnaf.STREET_TYPE_AUT CASCADE;
DROP TABLE gnaf.LOCALITY CASCADE;
DROP TABLE gnaf.STREET_SUFFIX_AUT CASCADE;
DROP TABLE gnaf.ADDRESS_TYPE_AUT CASCADE;
DROP TABLE gnaf.LOCALITY_CLASS_AUT CASCADE;
DROP TABLE gnaf.STATE CASCADE;
DROP TABLE gnaf.GEOCODE_RELIABILITY_AUT CASCADE;
