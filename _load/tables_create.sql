DROP TABLE gnaf.STREET_LOCALITY_POINT;
DROP TABLE gnaf.PRIMARY_SECONDARY;
DROP TABLE gnaf.ADDRESS_MESH_BLOCK_2016;
DROP TABLE gnaf.ADDRESS_SITE_GEOCODE;
DROP TABLE gnaf.LOCALITY_ALIAS;
DROP TABLE gnaf.LOCALITY_POINT;
DROP TABLE gnaf.ADDRESS_MESH_BLOCK_2011;
DROP TABLE gnaf.ADDRESS_ALIAS;
DROP TABLE gnaf.LOCALITY_NEIGHBOUR;
DROP TABLE gnaf.ADDRESS_DEFAULT_GEOCODE;
DROP TABLE gnaf.STREET_LOCALITY_ALIAS;
DROP TABLE gnaf.MB_2016;
DROP TABLE gnaf.ADDRESS_DETAIL;
DROP TABLE gnaf.MB_MATCH_CODE_AUT;
DROP TABLE gnaf.MB_2011;
DROP TABLE gnaf.STREET_LOCALITY_ALIAS_TYPE_AUT;
DROP TABLE gnaf.LOCALITY_ALIAS_TYPE_AUT;
DROP TABLE gnaf.GEOCODE_TYPE_AUT;
DROP TABLE gnaf.ADDRESS_ALIAS_TYPE_AUT;
DROP TABLE gnaf.PS_JOIN_TYPE_AUT;
DROP TABLE gnaf.GEOCODED_LEVEL_TYPE_AUT;
DROP TABLE gnaf.STREET_LOCALITY;
DROP TABLE gnaf.ADDRESS_SITE;
DROP TABLE gnaf.LEVEL_TYPE_AUT;
DROP TABLE gnaf.FLAT_TYPE_AUT;
DROP TABLE gnaf.STREET_TYPE_AUT;
DROP TABLE gnaf.LOCALITY;
DROP TABLE gnaf.STREET_CLASS_AUT;
DROP TABLE gnaf.STREET_SUFFIX_AUT;
DROP TABLE gnaf.ADDRESS_TYPE_AUT;
DROP TABLE gnaf.LOCALITY_CLASS_AUT;
DROP TABLE gnaf.STATE;
DROP TABLE gnaf.GEOCODE_RELIABILITY_AUT;
