...
class GNAFRegisterRenderer(pyldapi.RegisterRenderer):
    def _get_contained_items_from_db(self, page, per_page):
        ...
        try:
            ...
            if cic == 'http://gnafld.net/def/gnaf#Address':
            ...
            elif cic == 'http://gnafld.net/def/gnaf#Locality':
            ...
            elif cic == 'http://gnafld.net/def/gnaf#StreetLocality':
            ...
            elif cic == 'http://gnafld.net/def/gnaf#AddressSite':
